...
export const eip6963Connection: Connection & { selectProvider: (rdns: string) => void } = {
  selectProvider: (rdns: string) => eip6963.selectProvider(rdns), // used to switch the currently selected eip6963 wallet
